...
[drasyl_0.1.0_amd64.deb](https://controller.drasyl.org/releases/0.1.0/linux-amd64/drasyl_0.1.0_amd64.deb)

  </TabItem>
  <TabItem value="arm64" label="ARM64">

[drasyl_0.1.0_arm64.deb](https://controller.drasyl.org/releases/0.1.0/linux-amd64/drasyl_0.1.0_arm64.deb)
...
[drasyl-ui_0.1.0_amd64.deb](https://controller.drasyl.org/releases/0.1.0/linux-amd64/drasyl-ui_0.1.0_amd64.deb) (UI is currently only available for `x86_64`)
